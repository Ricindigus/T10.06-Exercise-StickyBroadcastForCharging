...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            ...
            if (batteryManager.isCharging()) showCharging(true);
            else showCharging(false);
        }else{
            IntentFilter intentFilter = new IntentFilter();
            intentFilter.addAction(Intent.ACTION_BATTERY_CHANGED);
            Intent intentBatteryStatus = registerReceiver(null,intentFilter);
            Bundle bundleExtras = intentBatteryStatus.getExtras();
            if (bundleExtras!= null && bundleExtras.containsKey(BatteryManager.EXTRA_STATUS)){
                int status = bundleExtras.getInt(BatteryManager.EXTRA_STATUS);
